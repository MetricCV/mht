...
img_output_dir = {'results/','results/',...
                        'results/','results/',...
                            'results/'};

% set your dataset directory here
img_input_dir = {'Dataset/Crowd_PETS09/', '/home/chanho/Research/tracking/2015_ICCV/MOT_Challenge/2DMOT2015/train/',...
...
% set the input/output image path
