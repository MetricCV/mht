%--------------------------------------------------------------------------
% Usage:
%    [iNumCliques, mtxCliques] = Cliquer.FindSingle(mtxAdj, iMinSize,
%       iMaxSize, bOnlyMaximal, iMaxNumCliques, mtxWeight)
% Description:
...
%    iMaxNumCliques (this is only for Cliquer.FindALL)
