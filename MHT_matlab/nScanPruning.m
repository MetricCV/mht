function [appTreeSet, obsTreeSet, stateTreeSet, scoreTreeSet, idTreeSet, incompabilityListTreeNodeIDSet, activeTreeSet, familyID, trackFamilyNew, trackIDtoRegInd] = nScanPruning(bestHypothesis, trackIndexInTrees, appTreeSetPrev, obsTreeSetPrev, ...
                                                                                                                             ...
                                                                                                                             familyID, treeDel, treeConfirmed, trackFamilyPrev, other_param, trackIDtoRegInd, cur_time)
...
if cur_time <= other_param.N + 1  || familyNo == 0 
    ...
    appTreeSet = appTreeSetPrev(idSel);
...
for i = 1:hypoNo
    ...
    for k = 1:length(ind)          
        ...
        if parentInd == 0
            appTreeSet(familyID,1) = appTreeSetPrev(familyIDPrev);  
